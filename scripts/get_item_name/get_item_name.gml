...
function get_item_name(argument0) {
	...
	switch(idd){
		...
		case 1:name = "Potion of "+global.pname[1];break;
		case 2:name = "Potion of "+global.pname[2];break;
		case 3:name = "Potion of "+global.pname[3];break;
		case 4:name = "Potion of "+global.pname[4];break;
		case 5:name = "Potion of "+global.pname[5];break;
		case 6:name = "Potion of "+global.pname[6];break;
		case 7:name = "Potion of "+global.pname[7];break;
		case 8:name = "Potion of "+global.pname[8];break;
		case 9:name = "Spell of Fireball";break;
		case 10:name = "Spell of Iceball";break;
		case 11:name = "Spell of FastAttack";break;
		case 12:name = "Spell of Dig";break;
