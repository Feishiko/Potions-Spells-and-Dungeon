...
function use(argument0) {
	...
	switch(idd){
		...
		case 1:show_log(global.name + " use " + s + ",You feel Your MaxHealth get UP!",c_green)
				global.mymaxhp += 2;
				global.myhp += 2;
				global.pname[1] = "MaxHealth Up";break;
		case 2:show_log(global.name + " use " + s + ",You feel Your Health get HEAL!",c_lime)
				global.myhp += 4;
				global.pname[2] = "Heal";break;
		case 3:show_log(global.name + " use " + s + ",You feel Your Health get DOWN",c_red)
				global.myhp -= 2;
				global.pname[3] = "Hurt";break;
		case 4:show_log(global.name + " use " + s + ",You feel You can see MORE!",c_yellow)
				global.lightrange += 50;
				global.pname[4] = "See More";break;
		case 5:show_log(global.name + " use " + s + ",You feel You can't see MORE!",c_red)
				global.lightrange -= 30;
				global.pname[5] = "See Less";break;
		case 6:show_log(global.name + " use " + s + ",You feel Your Speed get UP",c_yellow)
				global.sped += 0.5;
				global.pname[6] = "Speed Up";break;
		case 7:show_log(global.name + " use " + s + ",You feel Your Speed get DOWN!",c_red)
				global.sped -= 0.5;
				global.pname[7] = "Speed Down";break;
		case 8:show_log(global.name + " use " + s + ",You feel Your Health Full Heal!",c_green)
